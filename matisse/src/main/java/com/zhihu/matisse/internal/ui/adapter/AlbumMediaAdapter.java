    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            ...
            if (mSelectionSpec.onlyShowImages()) {
                // only image
                holder.mHint.setText(parent.getContext().getString(R.string.photo_grid_capture));
            } else if (mSelectionSpec.onlyShowVideos()) {
                // only video
                holder.mHint.setText(parent.getContext().getString(R.string.photo_grid_video));
            } else {
                // all
                holder.mHint.setText(parent.getContext().getString(R.string.photo_grid_capture_or_video));
            }
